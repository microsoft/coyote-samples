...
namespace Coyote.Examples.PingPong
{
    ...
    internal class Client
    {
        ...
        /// machine programming model. These async events will be fully explored by Coyote, testing
        ...
        public async ControlledTask Pong()
        {
            ...
            // "specifications" which are checked by Coyote to ensure certain invariants remain
            // true during the test process. In this case we want to ensure a Pong never arrives
            // here unless we are in the "active state" (in other words, we sent a Ping and we
